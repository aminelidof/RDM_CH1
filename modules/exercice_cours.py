...
# --- METHODE ANALYTIQUE ---
    ...
    with tab1:
        ...
        st.write("ℹ️ **Somme des forces verticales :**")
        st.latex(r"V(x) = R_A - q \cdot x")
        st.latex(r"V_1(x) = 114 - 20x")
        
        # Section Moment Fléchissant
        st.write("ℹ️ **Somme des moments au point x :**")
        # Ici on utilise latex pour la formule seule pour éviter le bug d'affichage
        st.latex(r"M(x) = R_A \cdot x - q \cdot \frac{x^2}{2}")
